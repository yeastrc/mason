...
PATH_TO_MASON_VIEWER_INDIVIDUAL_JS_FILES=../individual_js_files/


#  This variable MUST end in "/"

PATH_TO_MASON_VIEWER_COMBINED_MINIFIED_JS_FILES=../js_files_combined_to_one_and_minified/


#  This variable MUST end in "/"

PATH_TO_MASON_VIEWER_RUNSPACE=../combine_js_files_to_one_and_minify_runspace/
