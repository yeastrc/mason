...
//   secondary_structure_prediction_callbacks.js

//   This is the Peptipedia Secondary Structure Prediction specific set of callbacks for the Mason Viewer (prot_cov_viewer)
...
//	var MAX_COLOR = 255;
	...
	var SECONDARY_STRUCTURE_TYPE_CONSTANTS = {
	...
	var TOOL_TIP_FOR_LABEL = 
		...
		"Predicted using psipred version 3.4.  Jones DT. (1999)<BR>" +
		"Protein secondary structure prediction based on position-specific scoring matrices.<BR>" +
...
//		this.config = param.config;
	...
	MainRowsBlocks_callbackFunctions.prototype.precomputeColorOnCreateMainRowsBlocks = function( precomputeParams, precomputeColorParams ) {
		...
		if ( type === SECONDARY_STRUCTURE_TYPE_CONSTANTS.BETA_SHEET ) {
			
			colorForBlock = { red: 0, green: 0, blue: 255 };
			
		} else { //  type === this.SECONDARY_STRUCTURE_TYPE_CONSTANTS.ALPHA_HELIX )
			
			
			colorForBlock = { red: 0, green: 150, blue: 0 };
		}
	...
	MainRowsBlocks_callbackFunctions.prototype.precomputeNonOverlappingBlocksToolTipText = function( precomputeParams, precomputeToolTipTextParams ) {
		...
		if ( type === SECONDARY_STRUCTURE_TYPE_CONSTANTS.BETA_SHEET ) {
			...
			tooltipHTML +=TOOL_TIP_BETA_SHEET;
			
		} else { //  type === this.SECONDARY_STRUCTURE_TYPE_CONSTANTS.ALPHA_HELIX )
			
			
			tooltipHTML += TOOL_TIP_ALPHA_HELIX;
		}
