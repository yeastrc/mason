...
$(document).ready( function(){
	...
	var $multiRowMasonViewerRootDiv = $("#all_multi_row_all_features_mason_viewer");

	var $peptideAtlasMasonViewerRootDiv = $("#all_peptide_atlas_mason_viewer");



	var $philiusMasonViewerRootDiv = $("#all_philius-mason-viewer");

	var $secondaryStructurePredictionMasonViewerRootDiv = $("#all_secondary-structure-prediction-mason-viewer");


	var $coiledCoilMasonViewerRootDiv = $("#all_coiled-coil-mason-viewer");

	var $disorderedRegionsMasonViewerRootDiv = $("#all_disordered-regions-prediction-mason-viewer");
